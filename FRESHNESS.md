...
| `README.md`, `manifest.json`, `VERSION`, `CHANGELOG.md` | 2026-08-26 | Never | Synchronized as `0.3.0-pre.1`; explicitly records nine skills, NOT-RUN evaluations and publication blockers. | Pre-release metadata present; final release blocked |
...
5. Pre-release metadata exists at `0.3.0-pre.1`; a final release remains
